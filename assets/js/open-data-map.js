...
function show_map(data) {
  ...
  // set up map
  var map = L.map('mapid').setView([38, -97], 3);
  ...
  var wwcIcon = L.icon({ iconUrl: 'https://sunlightpolicy.github.io/opendatapoliciesstatic/assets/images/pin-wwc.png', iconSize: [24, 38] });
  var odpIcon = L.icon({ iconUrl: 'https://sunlightpolicy.github.io/opendatapoliciesstatic/assets/images/pin.png', iconSize: [24, 38]});
